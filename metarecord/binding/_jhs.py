...
Namespace = pyxb.namespace.NamespaceForURI(
    "http://skeemat.jhs-suositukset.fi/yhteiset/2009/10/19", create_if_missing=True
)
...
Namespace.addCategoryObject(
    "typeBinding", "EdellinenSukuNimiTyyppi", EdellinenSukuNimiTyyppi
)
...
class EnsimmainenRiviTekstiTyyppi(pyxb.binding.datatypes.string):
    ...
    _ExpandedName = pyxb.namespace.ExpandedName(
        Namespace, "EnsimmainenRiviTekstiTyyppi"
    )
    _XSDLocation = None
    _Documentation = None
...
Namespace.addCategoryObject(
    "typeBinding", "EnsimmainenRiviTekstiTyyppi", EnsimmainenRiviTekstiTyyppi
)
...
Namespace.addCategoryObject(
    "typeBinding", "FaksinumeroTekstiTyyppi", FaksinumeroTekstiTyyppi
)
...
Namespace.addCategoryObject(
    "typeBinding", "HuoltosuhdeTekstiTyyppi", HuoltosuhdeTekstiTyyppi
)
...
class HuoneistotunnisteNumeroTyyppi(pyxb.binding.datatypes.decimal):
    ...
    _ExpandedName = pyxb.namespace.ExpandedName(
        Namespace, "HuoneistotunnisteNumeroTyyppi"
    )
    _XSDLocation = None
    _Documentation = None
...
Namespace.addCategoryObject(
    "typeBinding", "HuoneistotunnisteNumeroTyyppi", HuoneistotunnisteNumeroTyyppi
)
...
class HuoneistotunnisteJakokirjainTekstiTyyppi(pyxb.binding.datatypes.string):
    ...
    _ExpandedName = pyxb.namespace.ExpandedName(
        Namespace, "HuoneistotunnisteJakokirjainTekstiTyyppi"
    )
    _XSDLocation = None
    _Documentation = None
...
Namespace.addCategoryObject(
    "typeBinding",
    "HuoneistotunnisteJakokirjainTekstiTyyppi",
    HuoneistotunnisteJakokirjainTekstiTyyppi,
)
_module_typeBindings.HuoneistotunnisteJakokirjainTekstiTyyppi = (
    HuoneistotunnisteJakokirjainTekstiTyyppi
)
...
class HuoneistotunnisteKirjainTekstiTyyppi(pyxb.binding.datatypes.string):
    ...
    _ExpandedName = pyxb.namespace.ExpandedName(
        Namespace, "HuoneistotunnisteKirjainTekstiTyyppi"
    )
    _XSDLocation = None
    _Documentation = None
...
Namespace.addCategoryObject(
    "typeBinding",
    "HuoneistotunnisteKirjainTekstiTyyppi",
    HuoneistotunnisteKirjainTekstiTyyppi,
)
_module_typeBindings.HuoneistotunnisteKirjainTekstiTyyppi = (
    HuoneistotunnisteKirjainTekstiTyyppi
)
...
Namespace.addCategoryObject(
    "typeBinding", "IkaluokkaTekstiTyyppi", IkaluokkaTekstiTyyppi
)
...
Namespace.addCategoryObject(
    "typeBinding", "KansalaisuusKoodiTyyppi", KansalaisuusKoodiTyyppi
)
...
Namespace.addCategoryObject(
    "typeBinding", "KolmasRiviTekstiTyyppi", KolmasRiviTekstiTyyppi
)
...
Namespace.addCategoryObject(
    "typeBinding", "KuudesRiviTekstiTyyppi", KuudesRiviTekstiTyyppi
)
...
Namespace.addCategoryObject(
    "typeBinding", "NeljasRiviTekstiTyyppi", NeljasRiviTekstiTyyppi
)
...
Namespace.addCategoryObject(
    "typeBinding", "PankkitiliTunnusTyyppi", PankkitiliTunnusTyyppi
)
...
class PostilokerolyhenneTekstiTyyppi(pyxb.binding.datatypes.string):
    ...
    _ExpandedName = pyxb.namespace.ExpandedName(
        Namespace, "PostilokerolyhenneTekstiTyyppi"
    )
    _XSDLocation = None
    _Documentation = None
...
Namespace.addCategoryObject(
    "typeBinding", "PostilokerolyhenneTekstiTyyppi", PostilokerolyhenneTekstiTyyppi
)
...
Namespace.addCategoryObject(
    "typeBinding", "PostilokeroTekstiTyyppi", PostilokeroTekstiTyyppi
)
...
Namespace.addCategoryObject(
    "typeBinding", "PostinumeroKoodiTyyppi", PostinumeroKoodiTyyppi
)
...
Namespace.addCategoryObject(
    "typeBinding", "PostitoimipaikkaNimiTyyppi", PostitoimipaikkaNimiTyyppi
)
...
Namespace.addCategoryObject(
    "typeBinding", "PuhelinnumeroTekstiTyyppi", PuhelinnumeroTekstiTyyppi
)
...
class SahkoinenAsiointiTunnusTyyppi(pyxb.binding.datatypes.string):
    ...
    _ExpandedName = pyxb.namespace.ExpandedName(
        Namespace, "SahkoinenAsiointiTunnusTyyppi"
    )
    _XSDLocation = None
    _Documentation = None
...
Namespace.addCategoryObject(
    "typeBinding", "SahkoinenAsiointiTunnusTyyppi", SahkoinenAsiointiTunnusTyyppi
)
...
class SahkopostiosoiteTekstiTyyppi(pyxb.binding.datatypes.string):
    ...
    _ExpandedName = pyxb.namespace.ExpandedName(
        Namespace, "SahkopostiosoiteTekstiTyyppi"
    )
    _XSDLocation = None
    _Documentation = None
...
Namespace.addCategoryObject(
    "typeBinding", "SahkopostiosoiteTekstiTyyppi", SahkopostiosoiteTekstiTyyppi
)
...
Namespace.addCategoryObject(
    "typeBinding", "SiviilisaatyTekstiTyyppi", SiviilisaatyTekstiTyyppi
)
...
Namespace.addCategoryObject(
    "typeBinding", "StatusryhmaTekstiTyyppi", StatusryhmaTekstiTyyppi
)
...
Namespace.addCategoryObject(
    "typeBinding", "ToinenRiviTekstiTyyppi", ToinenRiviTekstiTyyppi
)
...
Namespace.addCategoryObject(
    "typeBinding", "TurvakieltoKytkinTyyppi", TurvakieltoKytkinTyyppi
)
...
Namespace.addCategoryObject(
    "typeBinding", "UlkomaaHenkiloTunnusTyyppi", UlkomaaHenkiloTunnusTyyppi
)
...
class UlkomaaPostitoimipaikkaNimiTyyppi(pyxb.binding.datatypes.string):
    ...
    _ExpandedName = pyxb.namespace.ExpandedName(
        Namespace, "UlkomaaPostitoimipaikkaNimiTyyppi"
    )
    _XSDLocation = None
    _Documentation = None
...
Namespace.addCategoryObject(
    "typeBinding",
    "UlkomaaPostitoimipaikkaNimiTyyppi",
    UlkomaaPostitoimipaikkaNimiTyyppi,
)
_module_typeBindings.UlkomaaPostitoimipaikkaNimiTyyppi = (
    UlkomaaPostitoimipaikkaNimiTyyppi
)
...
Namespace.addCategoryObject(
    "typeBinding", "VakinainenKytkinTyyppi", VakinainenKytkinTyyppi
)
...
class ValiaikainenHenkiloTunnusTyyppi(pyxb.binding.datatypes.string):
    ...
    _ExpandedName = pyxb.namespace.ExpandedName(
        Namespace, "ValiaikainenHenkiloTunnusTyyppi"
    )
    _XSDLocation = None
    _Documentation = None
...
Namespace.addCategoryObject(
    "typeBinding", "ValiaikainenHenkiloTunnusTyyppi", ValiaikainenHenkiloTunnusTyyppi
)
...
Namespace.addCategoryObject(
    "typeBinding", "ValtiotunnusKoodiTyyppi", ValtiotunnusKoodiTyyppi
)
...
Namespace.addCategoryObject(
    "typeBinding", "ViidesRiviTekstiTyyppi", ViidesRiviTekstiTyyppi
)
...
Namespace.addCategoryObject(
    "typeBinding", "VoimassaoloKytkinTyyppi", VoimassaoloKytkinTyyppi
)
...
AlayksikkoNimi = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "AlayksikkoNimi"),
    AlayksikkoNimiTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", AlayksikkoNimi.name().localName(), AlayksikkoNimi
)

AlkuHetki = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "AlkuHetki"), AlkuHetkiTyyppi, location=None
)
Namespace.addCategoryObject("elementBinding", AlkuHetki.name().localName(), AlkuHetki)

AlkuPvm = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "AlkuPvm"), AlkuPvmTyyppi, location=None
)
Namespace.addCategoryObject("elementBinding", AlkuPvm.name().localName(), AlkuPvm)

AmmattiKoodi = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "AmmattiKoodi"),
    AmmattiKoodiTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", AmmattiKoodi.name().localName(), AmmattiKoodi
)

BICKoodi = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "BICKoodi"), BICKoodiTyyppi, location=None
)
Namespace.addCategoryObject("elementBinding", BICKoodi.name().localName(), BICKoodi)

CareOfTeksti = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "CareOfTeksti"),
    CareOfTekstiTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", CareOfTeksti.name().localName(), CareOfTeksti
)

EdellinenSukuNimi = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "EdellinenSukuNimi"),
    EdellinenSukuNimiTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", EdellinenSukuNimi.name().localName(), EdellinenSukuNimi
)

EnsimmainenRiviTeksti = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "EnsimmainenRiviTeksti"),
    EnsimmainenRiviTekstiTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", EnsimmainenRiviTeksti.name().localName(), EnsimmainenRiviTeksti
)

EtunimetNimi = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "EtunimetNimi"),
    EtunimetNimiTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", EtunimetNimi.name().localName(), EtunimetNimi
)

EtuNimi = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "EtuNimi"), EtuNimiTyyppi, location=None
)
Namespace.addCategoryObject("elementBinding", EtuNimi.name().localName(), EtuNimi)

FaksinumeroTeksti = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "FaksinumeroTeksti"),
    FaksinumeroTekstiTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", FaksinumeroTeksti.name().localName(), FaksinumeroTeksti
)

HenkiloTunnus = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "HenkiloTunnus"),
    HenkiloTunnusTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", HenkiloTunnus.name().localName(), HenkiloTunnus
)

HuoltosuhdeTeksti = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "HuoltosuhdeTeksti"),
    HuoltosuhdeTekstiTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", HuoltosuhdeTeksti.name().localName(), HuoltosuhdeTeksti
)

HuoneistotunnisteNumero = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "HuoneistotunnisteNumero"),
    HuoneistotunnisteNumeroTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding",
    HuoneistotunnisteNumero.name().localName(),
    HuoneistotunnisteNumero,
)

HuoneistotunnisteJakokirjainTeksti = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "HuoneistotunnisteJakokirjainTeksti"),
    HuoneistotunnisteJakokirjainTekstiTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding",
    HuoneistotunnisteJakokirjainTeksti.name().localName(),
    HuoneistotunnisteJakokirjainTeksti,
)

HuoneistotunnisteKirjainTeksti = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "HuoneistotunnisteKirjainTeksti"),
    HuoneistotunnisteKirjainTekstiTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding",
    HuoneistotunnisteKirjainTeksti.name().localName(),
    HuoneistotunnisteKirjainTeksti,
)

IBANTunnus = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "IBANTunnus"),
    IBANTunnusTyyppi,
    location=None,
)
Namespace.addCategoryObject("elementBinding", IBANTunnus.name().localName(), IBANTunnus)

IkaluokkaTeksti = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "IkaluokkaTeksti"),
    IkaluokkaTekstiTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", IkaluokkaTeksti.name().localName(), IkaluokkaTeksti
)

KansalaisuusKoodi = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "KansalaisuusKoodi"),
    KansalaisuusKoodiTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", KansalaisuusKoodi.name().localName(), KansalaisuusKoodi
)

KatuNimi = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "KatuNimi"), KatuNimiTyyppi, location=None
)
Namespace.addCategoryObject("elementBinding", KatuNimi.name().localName(), KatuNimi)

KieliKoodi = pyxb.binding.basis.element(
...
KolmasRiviTeksti = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "KolmasRiviTeksti"),
    KolmasRiviTekstiTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", KolmasRiviTeksti.name().localName(), KolmasRiviTeksti
)

KuntaKoodi = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "KuntaKoodi"),
    KuntaKoodiTyyppi,
    location=None,
)
Namespace.addCategoryObject("elementBinding", KuntaKoodi.name().localName(), KuntaKoodi)

KuntaNumero = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "KuntaNumero"),
    KuntaNumeroTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", KuntaNumero.name().localName(), KuntaNumero
)

KuolemaPvm = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "KuolemaPvm"),
    KuolemaPvmTyyppi,
    location=None,
)
Namespace.addCategoryObject("elementBinding", KuolemaPvm.name().localName(), KuolemaPvm)

KutsumaNimi = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "KutsumaNimi"),
    KutsumaNimiTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", KutsumaNimi.name().localName(), KutsumaNimi
)

KuudesRiviTeksti = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "KuudesRiviTeksti"),
    KuudesRiviTekstiTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", KuudesRiviTeksti.name().localName(), KuudesRiviTeksti
)
...
LajiKoodi = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "LajiKoodi"), LajiKoodiTyyppi, location=None
)
Namespace.addCategoryObject("elementBinding", LajiKoodi.name().localName(), LajiKoodi)

LajiTeksti = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "LajiTeksti"),
    LajiTekstiTyyppi,
    location=None,
)
Namespace.addCategoryObject("elementBinding", LajiTeksti.name().localName(), LajiTeksti)

LoppuHetki = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "LoppuHetki"),
    LoppuHetkiTyyppi,
    location=None,
)
Namespace.addCategoryObject("elementBinding", LoppuHetki.name().localName(), LoppuHetki)

LoppuPvm = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "LoppuPvm"), LoppuPvmTyyppi, location=None
)
Namespace.addCategoryObject("elementBinding", LoppuPvm.name().localName(), LoppuPvm)

MaatunnusKoodi = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "MaatunnusKoodi"),
    MaatunnusKoodiTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", MaatunnusKoodi.name().localName(), MaatunnusKoodi
)

NeljasRiviTeksti = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "NeljasRiviTeksti"),
    NeljasRiviTekstiTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", NeljasRiviTeksti.name().localName(), NeljasRiviTeksti
)

NimilajiKoodi = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "NimilajiKoodi"),
    NimilajiKoodiTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", NimilajiKoodi.name().localName(), NimilajiKoodi
)

Nimi = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "Nimi"), NimiTyyppi, location=None
)
Namespace.addCategoryObject("elementBinding", Nimi.name().localName(), Nimi)

OsoiteNumero = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "OsoiteNumero"),
    OsoiteNumeroTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", OsoiteNumero.name().localName(), OsoiteNumero
)

PaayksikkoNimi = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "PaayksikkoNimi"),
    PaayksikkoNimiTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", PaayksikkoNimi.name().localName(), PaayksikkoNimi
)

PankkitiliTunnus = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "PankkitiliTunnus"),
    PankkitiliTunnusTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", PankkitiliTunnus.name().localName(), PankkitiliTunnus
)

PostilokerolyhenneTeksti = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "PostilokerolyhenneTeksti"),
    PostilokerolyhenneTekstiTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding",
    PostilokerolyhenneTeksti.name().localName(),
    PostilokerolyhenneTeksti,
)

PostilokeroTeksti = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "PostilokeroTeksti"),
    PostilokeroTekstiTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", PostilokeroTeksti.name().localName(), PostilokeroTeksti
)

PostinumeroKoodi = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "PostinumeroKoodi"),
    PostinumeroKoodiTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", PostinumeroKoodi.name().localName(), PostinumeroKoodi
)

PostitoimipaikkaNimi = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "PostitoimipaikkaNimi"),
    PostitoimipaikkaNimiTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", PostitoimipaikkaNimi.name().localName(), PostitoimipaikkaNimi
)

PuhelinnumeroTeksti = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "PuhelinnumeroTeksti"),
    PuhelinnumeroTekstiTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", PuhelinnumeroTeksti.name().localName(), PuhelinnumeroTeksti
)

SahkoinenAsiointiTunnus = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "SahkoinenAsiointiTunnus"),
    SahkoinenAsiointiTunnusTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding",
    SahkoinenAsiointiTunnus.name().localName(),
    SahkoinenAsiointiTunnus,
)

SahkopostiosoiteTeksti = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "SahkopostiosoiteTeksti"),
    SahkopostiosoiteTekstiTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", SahkopostiosoiteTeksti.name().localName(), SahkopostiosoiteTeksti
)

SiviilisaatyTeksti = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "SiviilisaatyTeksti"),
    SiviilisaatyTekstiTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", SiviilisaatyTeksti.name().localName(), SiviilisaatyTeksti
)

StatusryhmaTeksti = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "StatusryhmaTeksti"),
    StatusryhmaTekstiTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", StatusryhmaTeksti.name().localName(), StatusryhmaTeksti
)

SukuNimi = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "SukuNimi"), SukuNimiTyyppi, location=None
)
Namespace.addCategoryObject("elementBinding", SukuNimi.name().localName(), SukuNimi)

SukupuoliKoodi = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "SukupuoliKoodi"),
    SukupuoliKoodiTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", SukupuoliKoodi.name().localName(), SukupuoliKoodi
)

SyntymaPvm = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "SyntymaPvm"),
    SyntymaPvmTyyppi,
    location=None,
)
Namespace.addCategoryObject("elementBinding", SyntymaPvm.name().localName(), SyntymaPvm)

ToinenRiviTeksti = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "ToinenRiviTeksti"),
    ToinenRiviTekstiTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", ToinenRiviTeksti.name().localName(), ToinenRiviTeksti
)

TurvakieltoKytkin = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "TurvakieltoKytkin"),
    TurvakieltoKytkinTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", TurvakieltoKytkin.name().localName(), TurvakieltoKytkin
)

UlkomaaHenkiloTunnus = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "UlkomaaHenkiloTunnus"),
    UlkomaaHenkiloTunnusTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", UlkomaaHenkiloTunnus.name().localName(), UlkomaaHenkiloTunnus
)

UlkomaaPostitoimipaikkaNimi = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "UlkomaaPostitoimipaikkaNimi"),
    UlkomaaPostitoimipaikkaNimiTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding",
    UlkomaaPostitoimipaikkaNimi.name().localName(),
    UlkomaaPostitoimipaikkaNimi,
)

VakinainenKytkin = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "VakinainenKytkin"),
    VakinainenKytkinTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", VakinainenKytkin.name().localName(), VakinainenKytkin
)

ValiaikainenHenkiloTunnus = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "ValiaikainenHenkiloTunnus"),
    ValiaikainenHenkiloTunnusTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding",
    ValiaikainenHenkiloTunnus.name().localName(),
    ValiaikainenHenkiloTunnus,
)

ValtiotunnusKoodi = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "ValtiotunnusKoodi"),
    ValtiotunnusKoodiTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", ValtiotunnusKoodi.name().localName(), ValtiotunnusKoodi
)

ViidesRiviTeksti = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "ViidesRiviTeksti"),
    ViidesRiviTekstiTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", ViidesRiviTeksti.name().localName(), ViidesRiviTeksti
)

VoimassaoloKytkin = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "VoimassaoloKytkin"),
    VoimassaoloKytkinTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", VoimassaoloKytkin.name().localName(), VoimassaoloKytkin
)

YritysTunnus = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "YritysTunnus"),
    YritysTunnusTyyppi,
    location=None,
)
Namespace.addCategoryObject(
    "elementBinding", YritysTunnus.name().localName(), YritysTunnus
)
