...
def parent_classification():
    return Classification.objects.create(
        title="test parent classification", code="00", function_allowed=False
    )
...
def record(action):
    return Record.objects.create(
        attributes={"TypeSpecifier": "test record"}, action=action, index=1
    )
...
def bulk_update():
    return BulkUpdate.objects.create(
        description="Lorem ipsum dolor sit amet", state=Function.DRAFT, changes={}
    )
...
def choice_attribute():
    return Attribute.objects.create(
        name="test choice attribute",
        identifier="ChoiceAttr",
        help_text="test choice attribute help text",
    )
...
def choice_attribute_2():
    return Attribute.objects.create(
        name="test choice attribute 2", identifier="ChoiceAttr2"
    )
...
def free_text_attribute():
    return Attribute.objects.create(
        name="test free text attribute", identifier="FreeTextAttr"
    )
...
def free_text_attribute_2():
    return Attribute.objects.create(
        name="test free text attribute 2", identifier="FreeTextAttr2"
    )
...
def choice_value_1(choice_attribute):
    return AttributeValue.objects.create(
        value="test choice value 1",
        attribute=choice_attribute,
        name="test name",
...
def choice_value_2(choice_attribute):
    return AttributeValue.objects.create(
        value="test choice value 2", attribute=choice_attribute
    )
...
def choice_value_2_1(choice_attribute_2):
    return AttributeValue.objects.create(
        value="test choice value 2 1", attribute=choice_attribute_2
    )
...
def choice_value_2_2(choice_attribute_2):
    return AttributeValue.objects.create(
        value="test choice value 2 2", attribute=choice_attribute_2
    )
