...
def test_attribute_values_will_get_index_numbers(free_text_attribute):
    attribute_value_1 = AttributeValue.objects.create(value='attribute value 1', attribute=free_text_attribute)
    assert attribute_value_1.index == 1

    attribute_value_2 = AttributeValue.objects.create(value='attribute value 2', attribute=free_text_attribute)
