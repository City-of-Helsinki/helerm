...
class ClassificationSerializer(serializers.ModelSerializer):
    ...
    def validate_state_change(self, old_state, new_state):
        ...
        valid_changes = {
            ...
            Classification.SENT_FOR_REVIEW: {Classification.WAITING_FOR_APPROVAL, Classification.DRAFT},
            Classification.WAITING_FOR_APPROVAL: {Classification.APPROVED, Classification.DRAFT},
